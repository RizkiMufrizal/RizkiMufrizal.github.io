...
Pada [tutorial sebelumnya](https://rizkimufrizal.github.io/instalasi-perlengkapan-coding-node-js/){:target="_blank"} penulis telah membahas bagaimana cara instalasi untuk coding node js. Kali ini kita akan belajar bagaimana membagun sebuah aplikasi berbasis node js.
